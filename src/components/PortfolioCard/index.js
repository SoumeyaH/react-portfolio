...
<div class="card text-center my-4 mx-auto shadow-lg portfolio-card">
  ...
  <div class="card-body">
    ...
    <p class="m-2">
      Event Jam is a dynamic online application that offer users the ability to
      search for events in any city in the UK and get relevant, reliable and up
      to date Covid-19 information for that area.
    </p>
    <p class="m-2 fst-italic text-muted">
      HTML/CSS, Bulma, JS (ES6), jQuery, Chart.js, Third-Party APIs, Git
    </p>
